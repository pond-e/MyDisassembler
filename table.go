...
var OP_LOOKUP_SAME_KEY = map[PrefixOpcode][]RegOperator{
	...
	{Prefix: PrefixREX, Opcode: 0x80}: {
		{Reg: 0, Operator: MnADD},
		{Reg: 2, Operator: MnADC},
		{Reg: 5, Operator: MnSUB},
		{Reg: 3, Operator: MnSBB},
		{Reg: 4, Operator: MnAND},
		{Reg: 1, Operator: MnOR},
		{Reg: 6, Operator: MnXOR},
		{Reg: 7, Operator: MnCMP},
	},
	{Prefix: PrefixNONE, Opcode: 0x81}: {
		{Reg: 0, Operator: MnADD},
		{Reg: 2, Operator: MnADC},
		{Reg: 5, Operator: MnSUB},
		{Reg: 3, Operator: MnSBB},
...
var OPERAND_LOOKUP = map[PrefixMnemonicInt]OpEncVecStrVecOprand{
	...
	// ADD
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x04}: {openc: OpEncI, vecString: []string{"ib"}, vecOperand: []Operand{OpAl, OpImm8}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x05}: {openc: OpEncI, vecString: []string{"id"}, vecOperand: []Operand{OpEax, OpImm32}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x05}: {openc: OpEncI, vecString: []string{"id"}, vecOperand: []Operand{OpEax, OpImm32}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x80}: {openc: OpEncMI, vecString: []string{"ib"}, vecOperand: []Operand{OpRm8, OpImm8}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x80}: {openc: OpEncMI, vecString: []string{"ib"}, vecOperand: []Operand{OpRm8, OpImm8}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x81}: {openc: OpEncMI, vecString: []string{"id"}, vecOperand: []Operand{OpRm32, OpImm32}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x81}: {openc: OpEncMI, vecString: []string{"id"}, vecOperand: []Operand{OpRm32, OpImm32}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x83}: {openc: OpEncMI, vecString: []string{"ib"}, vecOperand: []Operand{OpRm32, OpImm8}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x83}: {openc: OpEncMI, vecString: []string{"ib"}, vecOperand: []Operand{OpRm64, OpImm8}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x00}: {openc: OpEncMR, vecString: []string{"/r"}, vecOperand: []Operand{OpRm8, OpReg8}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x01}: {openc: OpEncMR, vecString: []string{"/r"}, vecOperand: []Operand{OpRm32, OpReg32}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x01}: {openc: OpEncMR, vecString: []string{"/r"}, vecOperand: []Operand{OpRm64, OpReg64}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x02}: {openc: OpEncRM, vecString: []string{"ib"}, vecOperand: []Operand{OpReg8, OpRm8}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x02}: {openc: OpEncRM, vecString: []string{"ib"}, vecOperand: []Operand{OpReg8, OpRm8}},
	{prefix: PrefixNONE, mnemonic: MnADD, num: 0x03}: {openc: OpEncRM, vecString: []string{"/r"}, vecOperand: []Operand{OpReg32, OpRm32}},
	{prefix: PrefixREXW, mnemonic: MnADD, num: 0x03}: {openc: OpEncRM, vecString: []string{"/r"}, vecOperand: []Operand{OpReg64, OpRm64}},
